...
export function PageBackground() {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      {/* Aurora orb — center */}
      <motion.div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full blur-[140px]"
      ...
      <motion.div
        className="absolute bottom-0 right-0 w-[550px] h-[550px] rounded-full blur-[120px]"
      ...
      <motion.div
        className="absolute bottom-0 -left-24 w-[400px] h-[400px] rounded-full blur-[100px]"
